...
export interface Groups {
  ...
  mkb2: { id: string };
  styret: { id: string };
  conductors: { id: string };
  gigmasters: { id: string };
  partycommittee: { id: string };
  concertmasters: { id: string };
  webmasters: { id: string };
  recruiters: { id: string };
  utantillkommitten: { id: string };
  sheetfishes: { id: string };
  admins: { id: string };
}
